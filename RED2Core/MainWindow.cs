...
namespace RED2Core
{
    public partial class MainWindow : Form
    {
        ...
        private void fMain_Load(object sender, EventArgs e)
        {
            ...
            // Update labels
            this.lblRedStats.Text = String.Format(RED2Core.Properties.Resources.red_deleted, Properties.Settings.Default.delete_stats);
        ...
        void Default_SettingChanging(object sender, System.Configuration.SettingChangingEventArgs e)
        {
            ...
            {
                if (MessageBox.Show(this, SystemFunctions.ConvertLineBreaks(RED2Core.Properties.Resources.warning_really_delete), RED2Core.Properties.Resources.warning, MessageBoxButtons.OKCancel, MessageBoxIcon.Asterisk) == DialogResult.Cancel)
                    e.Cancel = true;
            }
        ...
        private void drawDirectoryIcons()
        {
            ...
            icons.Add("home", RED2Core.Properties.Resources.icon_root);
            icons.Add("folder", RED2Core.Properties.Resources.icon_default);
            icons.Add("folder_trash_files", RED2Core.Properties.Resources.icon_contains_trash);
            icons.Add("folder_hidden", RED2Core.Properties.Resources.icon_hidden_folder);
            icons.Add("folder_lock", RED2Core.Properties.Resources.icon_locked_folder);
            icons.Add("folder_warning", RED2Core.Properties.Resources.icon_warning);
            icons.Add("protected_icon", RED2Core.Properties.Resources.icon_protected_folder);
            icons.Add("deleted", RED2Core.Properties.Resources.icon_deleted_folder);
        ...
        private void btnScan_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show(this, RED2Core.Properties.Resources.error_dir_does_not_exist);
                    return;
                }
            }
            catch (Exception ex)
            ...
            setStatusAndLogMessage(RED2Core.Properties.Resources.searching_empty_folders);
        ...
        void core_OnFoundFinishedScanForEmptyDirs(object sender, FinishedScanForEmptyDirsEventArgs e)
        {
            ...
            setStatusAndLogMessage(String.Format(
                RED2Core.Properties.Resources.found_x_empty_folders, 
                e.EmptyFolderCount, 
                e.FolderCount,
            ...
            this.btnScan.Text = RED2Core.Properties.Resources.btn_scan_again;
        }
        ...
        {
            this.Data.AddLogSpacer();
            setStatusAndLogMessage(RED2Core.Properties.Resources.started_deletion_process);
        ...
        private void core_OnDeleteProcessChanged(object sender, DeleteProcessUpdateEventArgs e)
        {
            switch (e.Status)
            {
                case DirectoryDeletionStatusTypes.Deleted:
                    this.lbStatus.Text = String.Format(RED2Core.Properties.Resources.removing_empty_folders, (e.ProgressStatus + 1), e.FolderCount);
        ...
        private void core_OnDeleteProcessFinished(object sender, DeleteProcessFinishedEventArgs e)
        {
            ...
            setStatusAndLogMessage(
                String.Format(RED2Core.Properties.Resources.delete_process_finished, 
        ...
        private void core_OnCancelled(object sender, EventArgs e)
        {
            ...
            if (this.core.CurrentProcessStep == WorkflowSteps.DeleteProcessRunning)
                setStatusAndLogMessage(RED2Core.Properties.Resources.deletion_aborted);
            else
                setStatusAndLogMessage(RED2Core.Properties.Resources.process_cancelled);
        ...
        private void core_OnAborted(object sender, EventArgs e)
        {
            ...
            if (this.core.CurrentProcessStep == WorkflowSteps.DeleteProcessRunning)
                ...
                setStatusAndLogMessage(RED2Core.Properties.Resources.process_aborted);
        ...
        private void fMain_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (s.Length == 1)
                ...
                MessageBox.Show(this, RED2Core.Properties.Resources.error_only_one_folder);
        }
