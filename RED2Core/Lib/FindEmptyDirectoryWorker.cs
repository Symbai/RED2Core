            ...
            try
            {
                ...
                foreach (var curDir in subFolderList)
                {
                    ...
                    if (!ignoreSubDirectory)
                    {
                        ...
                        {
                            this.Data.AddLogMessage(String.Format(RED2Core.Properties.Resources.young_folder_skipped, curDir.FullName, this.Data.MinFolderAgeHours.ToString(), curDir.CreationTime.ToString()));
                        }
